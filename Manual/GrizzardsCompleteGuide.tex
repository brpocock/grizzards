...
WRITEME
  ...
  Cornet is a magenta Grizzard with a large neck frill.
...
\begin{grizzardpage}{Ambren}{18}{40}{20}{20}{Altrix}
  ...
  Ambren is an orange horned Grizzard.
...
WRITEME
  ...
  Noctis is a cyan, fat-tailed Grizzard.
...
WRITEME
  ...
  Corlyn is a green, horned Grizzard.
...
Wapow is a gold, hump-backed Grizzard.
...
WRITEME
  ...
  Zendex is a turquoise anole-like Grizzard.

\end{grizzardpage}

\begin{grizzardpage}{Oceax}{23}{45}{25}{25}{}

  Oceax is a pink alligator-like Grizzard.

\end{grizzardpage}

\begin{grizzardpage}{Flitex}{24}{45}{25}{25}{}

Flitex is a blue gecko-like Grizzard.
...
WRITEME
  ...
  Ectrix is a purple gecko-like Grizzard.
...
WRITEME
  ...
  Ortrix is a yellow gecko-like Grizzard. % WRITEME shape
...
WRITEME
  ...
  The only way to acquire Megax is by evolving one from Petty.

  Megax is an indigo, bipedal Grizzard.
...
\begin{bosspage}{One-Eyed Cyclop}{22}{22}{24}{60}
...
and the  date (and  time) of  the build  of the  game will  be displayed
as well.
...
There is  a secret room  to be found  … in which  you can catch  the two
Starter  Grizzards that  you did  not choose  (assuming it's  your first
game, and not  a New Game Plus)  and also review the exact  build of the
game that  you have. To  access the secret  room, try exploring  the Red
Cliffs on Port Lion … there may be a barrier that allows you through, if
you have the right companion …
...
\chapter{Quest Walkthroughs}

This  chapter  contains detailed  walkthroughs  of  specific quests  and
spoilers for the story.

\section{The Lovers}

One of the  first people you encounter in Treble  Village (on the screen
west  of the  town square)  is missing  their beloved,  who has  fled to
Anchor Village.

When  you reach  Anchor, you  can  find him  on  the south  edge of  the
Southern  Fields. He'll  give you  a note  to take  to his  beloved back
in Treble.

Don't  forget to  return to  Anchor  to let  him know  that his  beloved
is safe!

\section{Calling a Ship}

The man on the  docks in Treble gives you two pieces  of advice --- that
ships won't come to Treble Docks unless  you call them on the radio; and
also, that to the south are tunnels to the field where many people live.

If you follow  the road most directly south from  the docks area, you'll
pass by the Lost Mine's entrance and reach a radio repair shop. Make not
of its location  --- you'll need to  come back once you have  a radio to
be repaired.

Later, when you reach Anchor, visit the house just west of the big rock.
The  woman inside  will  tell you  she  has a  radio,  but it's  broken.
Good thing you took notes about that radio repair shop!

Backtrack up to  there, and talk to the repairman.  He'll fix the radio,
and if you talk to him again, he'll get out of there, too.

Back in Anchor, the woman will be  so happy that she'll gladly radio for
a ship for you. Return to Treble Docks to sail to Port Lion.

\section{Opening the Tunnels}

When you reach the place at which the funnels to Anchor are meant to be,
you'll find that they've been closed  off somehow. The woman standing by
the entrance will let you know that she needs two artifacts that were in
Treble to  open the tunnels again.  But Treble is all  but destroyed ---
where could those artifacts have got to?

Make sure  to agree  to help  her, or the  guardians of  those artifacts
won't be willing to give them up to you!

One of  them can  be found  in the farthest  northeastern corner  of the
Fire Bog. The guardian  will give it to you if  you have permission from
the tunnel guardian.

The other  artifact is in the  Spiral Wood, near the  entrance; when you
see the  signpost advising you that  you've entered the woods,  go north
one screen. This  poor guardian has been beset by  monsters; you'll have
to defeat both monsters that are harassing him to get his artifact.

Once you have  both artifacts, return to the tunnel  guardian and she'll
open the entrance.

\section{The Grizzard Trainer}

In  Anchor, a  retired Grizzard  trainer lives  in the  west-most house.
After  speaking  to  her,  she'll  mention  having  lost  a  pendant  in
the woods.

Visit  Spiral Wood  and look  for a  screen where  there are  no monster
encounters,   near   the   Southeast   corner.   Explore   that   screen
a bit\footnote{If you're having trouble locating it, sometimes saving at
  a  Depot and  returning later  may  help. The  pendant is  not in  any
  certain, fixed position.} and you should find the missing pendant.

Return the pendant  to her, and she'll  be grateful and give  you a key.
A key to what?  you might ask; in fact, do ask her,  and she'll tell you
about a cave  to the north where  she left some Grizzards.  In fact, the
key gives you  access not only to  her cave, but also  a Grizzard Depot!
The cave is just west of the tunnels into Mt Peshon.

Inside, you'll find three Grizzards, each of which can metamorphose into
a more powerful form.

\section{Miranda and Gary}

Miranda  lives in  the bustling  little  metropolis that  is Port  Lion.
Ask around, and  you'll hear about her --- and  her impressive knowledge
of legends. You'll also hear  about her ongoing bitter relationship with
her neighbor, Gary. The do \emph{not} like one another at all.

When you first meet her, Miranda is missing a mirror. Gary will tell you
he doesn't know anything about it --- \emph{and he's telling the truth}.
Despite  his animosity  for Miranda,  Gary has  nothing to  do with  her
missing mirror.

In  fact, you'll  want  to head  north,  to the  beaches,  and find  the
fisherman  in the  northeast corner  who's being  harassed by  monsters.
Defeat the monsters and  speak to him, and he'll tell  you just where to
look for Miranda's mirror.

Once  you've explored  the  screen  that the  fisherman  pointed you  to
thoroughly, you're sure to find the  mirror. Take it back to Miranda (or
speak to Gary  first to let him know he's  been vindicated). She'll tell
you some  of the ultimate secrets  of the game ---  \emph{who} is behind
the arrival of the monsters, and \emph{how} to reach them.

What  she  can't  tell  you,  though, is  \emph{where}  to  reach  them.
For that, you'll need an expert on local geography --- enter Fat Tony.

There are a bunch  of places where you can encounter  Fat Tony --- check
around, until he  points out something interesting. He'll  also tell you
about an implement that he needs in order to open the entrance.

One of the  villagers on the island  has the implement he  needs --- and
has got it from a rather unexpected  place. If you talk to each of them,
you'll  find  that  they  have  precisely what  you  were  looking  for.
Return it to Fat Tony and he'll use  it to reveal the entrance in a tiny
``cut scene.''

\section{Peter}

One of the Port  Lion villagers will tell you that  his son, Peter, went
missing while  playing atop  the Red  Cliffs. But  wait ---  that's just
where the  entrance to the  Labyrinth was. Surely little  Peter couldn't
have made his way in there?

You guessed it --- he most certainly did.

In the  course of  the Three  Dragons quest  (below), you'll  find Peter
hanging out inside a dragon's lair. Return him to his father and talk to
him a couple of times. Peter's father, in a show of gratitude, will give
you a cookie.

What to do with a cookie, you  might ask? Well, in the northwest area of
the  Port Lion  village, you'll  find someone  who's very  (\emph{very})
enthusiastic about that cookie. Make sure to  talk to him a few times to
learn just how happy you've made him.

\section{The Labyrinth}

The Labyrinth is a confusing maze  of multiple levels, but the basics of
what you want  to do to defeat  the bosses of the  monsters are actually
pretty straightforward.

First, you'll need to learn the  language of the ancient runes, in order
to read anything in the  Labyrinth. Luckily, there's a ``Rosetta Stone''
type signpost that  gives you perfect knowledge of  the runes instantly.
Once  you've learned  the runes,  you'll be  looking for  six signposts:
three each that tell you where the dragons' lairs are located, and three
more that have levers to open those entrances.

Flip each  lever and approach each  dragon's lair. You'll note  that the
dragons are increasingly powerful, in alphabetical order; i.e. Andrew is
the least difficult to defeat.

Each dragon's lair has a Grizzard Depot located within.

When  you have  defeated all  three dragons,  you'll see  a small  ``cut
scene''  as the  Boss Bear  approaches.  Your Grizzard  will also  quaff
a potion, so they'll be ready to fight again.

Defeat the Boss Bear, and the game  is over. If you have any side quests
you wanted to complete, or Grizzards  left to catch or metamorphose, you
should  do so  \emph{before}  you  face the  third  dragon (in  whatever
order).
