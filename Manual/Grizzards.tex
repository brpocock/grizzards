...
\begin{document}
\frontmatter
\includepdf[fitpaper=true]{../Manual/Cover.png}
...
On  an Atari  2600 (or  similar console),  push the  \textbf{Color/B\&W}
switch  into  the \textbf{Color}  position  to  play  the game,  or  the
\textbf{B\&W} position to pause.
...
Your progress is saved whenever you visit a Grizzard Depot.
...
a  response.  To review  what  the  person  was  asking, press  left  on
the joystick.
...
will be \ifdefined\TVSECAM white. \else red. \fi
...
Grizzard) will be \ifdefined\TVSECAM magenta\else indigo\fi{}. 
...
appear in light  blue. If your Grizzard does \emph{not}  a Move, it will
appear in black.
...
Moves that  your Grizzard  might be  able to perform,  but does  not yet
know, will appear in black.
...
Press the \textbf{Fire} button to leave it.
...
after each party of monsters that you defeat.
...
earn points for other some other actions you take in the game.
...
Grizzard is able  to learn up to  8 different moves, in  addition to the
...
the  Map   screen.  You  can   not  use   a  potion  during   a  battle.
...
a certain amount  of experience by battling monsters.

\columnbreak
\chapter{Monsters}

A slew of monsters are arriving in Syrex, terrorizing the land. A few of
...
If you're  not careful,  you may  be eaten  by a  Grue.
...
Spiral  Woods.  They  burst  from  the  trees  to  pillage  unsuspecting
travelers, but they do move \emph{very} slowly.

\vspace{14pt}

\lettrine[image=true,                lines=5,               findent=3pt,
nindent=3pt]{../Manual/Radish-Goblin.png}{Radish} Goblins  are possessed
plants  that  pluck  themselves  from   the  ground  and  attack  unwary
travelers. They  are well  known as among  the more  dangerous dangerous
root vegetables.
...
durable, so it  can take a while  to chip away at their  hit points.
...
\includepdf[fitpaper=true]{../Manual/SyrexMap.png}
