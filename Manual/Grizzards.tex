...
\begin{tikzpicture}[overlay, remember picture]
  ...
  {\includegraphics[interpolate,width=6in,height=9in]{../Manual/Cover.eps}}; 
\end{tikzpicture}
\else
\begin{tikzpicture}[overlay, remember picture]
  \node[anchor=north west, xshift=-4pt, yshift=4pt] 
  at (current page.north west)
  {\includegraphics[interpolate,width=\paperwidth,height=\paperheight]{../Manual/Cover.eps}}; 
\end{tikzpicture}
\fi
...
\textsc{A Grue}  is a sinister, lurking  presence in the dark  places of
the earth. Its favorite diet is adventurers, but its insatiable appetite
...
If you're not careful, you are likely to be eaten by a Grue.
...
\begin{tikzpicture}[overlay, remember picture]
  \node[anchor=north west, xshift=-4pt, yshift=4pt] 
  at (current page.north west)
  {\includegraphics[interpolate,width=6in,height=9in]{../Manual/SyrexMap.eps}};
\end{tikzpicture}
\else
\begin{tikzpicture}[overlay, remember picture]
  \node[anchor=north west, xshift=-4pt, yshift=4pt] 
