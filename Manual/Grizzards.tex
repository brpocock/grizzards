...
\ifdefined\ATARIAGESAVE
\vfill
\includegraphics[width=.7\columnwidth]{../Manual/AtariVox.jpeg}
\fi
...
last page  \fi of  this manual  to learn about  the geography  of Syrex.
...
\twocolumn[\chapter{Grizzards and Moves}\label{ch:Grizzards}]
