...
\fi\ifdefined\DEMO Demo \fi\ifdefined\ATARIAGESAVE\else Public Release\fi Player's Guide
...
Video  Arcade or  Atari  7800 ProSystem)  \ifdefined\ATARIAGESAVE with  optional
...
right to choose  a memory slot\footnote{Technical Note:  The Slot number
  chosen here  is relative to  the \ifdefined\ATARIAGESAVE four \else  three \fi
  save  game   slots  used  by  the   \textit{Grizzards}  game  program.
  \ifdefined\ATARIAGESAVE\else Each save game slot actually occupies 4 blocks on
  your memory device. \fi} for your game. There are \ifdefined\ATARIAGESAVE four
...
party, with up to 30 total  Grizzards saved in your \ifdefined\ATARIAGESAVE save
...
\ifdefined\NOSAVE\else
Your progress  will \emph{immediately} be saved  to your \ifdefined\ATARIAGESAVE
...
Novice) position, then you can't erase a game slot. \ifdefined\ATARIAGESAVE\else
...
This game uses the advanced  capabilities of AtariAge's cartridge system
to   save  your   progress   to   an  EEPROM   chip   inside  the   game
cartridge itself.
