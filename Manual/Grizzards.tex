...
A   RetroGameBoyz    ``Joy2b+''   game    pad   can   also    be   used.
...
\ifdefined\ATARIAGESAVE\else If using a Harmony cartridge, hold down the
\encircle{B} button when you power on  your console, or the gamepad will
not work on the Harmony menu. \fi
