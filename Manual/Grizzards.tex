...
If  your  Grizzard knows  how  to  perform a  move,  it  will appear  in
\ifdefined\TVNTSC color. \else colour. \fi If your Grizzard does not yet
...
bar will change to a red \ifdefined\TVNTSC color. \else colour. \fi
