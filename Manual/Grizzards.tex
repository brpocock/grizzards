...
\hypersetup{
    ...
    pdfsubject={Grizzards video game for the Atari 2600},
...
\begin{tikzpicture}[overlay, remember picture]
  ...
  {\noindent{}\includegraphics[width=5.25in,height=7.25in,interpolate]{../Manual/Cover.pdf}};
\end{tikzpicture}
\else
\begin{tikzpicture}[overlay, remember picture]
...
In the  \textit{Grizzards} video game, you'll  roam the land  looking for
...
{ \footnotesize This is the \textit{Grizzards} \ifdefined\NOSAVE No-Save
  ...
  Public Release \fi Player's Guide, Revision 2. }

\picaskip

{ \footnotesize  The \textit{Grizzards}  video game  software, including
  its audiovisual components and this manual, are copyright \copyright{}
  2022, Bruce-Robert Pocock, \copyright{} 2026 Interworldly Adventuring,
  LLC. All Rights are Reserved except as granted under license. }

\picaskip

{ \footnotesize For Atari Video  Computer System CX-2600 (or compatible)
  \ifdefined\ATARIAGESAVE  with optional  AtariVox device  (for speech).
    Compatible with  Stella and Atari  Plus (2600+, 7800+)  devices with
    updated  firmware. \else  \ifdefined\NOSAVE without  \else with  \fi
    AtariVox (or MemCard, or  SaveKey) device. \fi Screenshots represent
  the NTSC version; other versions have distinct coloring. }

\picaskip

{   \footnotesize   Licensed   by   AtariAge,  a   division   of   Atari
  International. }
...
Published by AtariAge, a division of Atari International. \href{https://atariage.com/}{https://atariage.com/}
...
\hred{mailto:support@interworldly.com}{support@interworldly.com} so that
...
\href{mailto:support@interworldly.com}{support@interworldly.com}     for
...
\ifdefined\ATARIAGESAVE  AtariAge save-to-cartridge  code \else  SaveKey
  EEPROM \fi{} and  AtariVox speech synthesis driver is  based upon code
by Alex Herbert.
