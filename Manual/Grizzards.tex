...
not work with certain multi-carts, e.g. the UnoCart. \fi
...
You can press the \textbf{Game  Select} switch\footnote{You can also use
  the  \encircle{C}  or  \encircle{II}  button on  a  gamepad.  See  the
  Gamepads  section on  page~\pageref{sec:Gamepad}.}  while viewing  the
Map,  Combat screen,  or at  a Grizzard  Depot to  view your  Grizzard's
...
after each  party of  monsters that  you defeat.  The more  skilled your
Grizzard becomes, the less often its levels will go up.
...
A slew of monsters are arriving  in Syrex, terrorizing the people. A few
...
If you're  not careful,  you may  be eaten  by a  Grue. Whenever  one is
lurking around, folks will avoid the area altogether.
