...
%
\documentclass[10pt,twocolumn,showtrims,openany,article]{memoir}
...
\setlrmarginsandblock{.75in}{.25in}{*}
...
\ifdefined\TVNTSC
\newcommand\TV{NTSC}
\newcommand\REGION{US, Canada, Mexico, Brazil, Korea, and Japan}
\else
\ifdefined\TVPAL
\newcommand\TV{PAL}
...
\includepdf[height=\paperheight,width=\paperwidth]{../Manual/Cover.png}
...
standard.   For  Atari   Video   Computer  System   CX-2600  (or   Atari
2600\textit{jr},  Sears   Tele-Games  Video  Arcade  ,   or  Atari  7800
ProSystem)  \ifdefined\NOSAVE  without  \else   with  \fi  AtariVox  (or
...
This game is published by AtariAge. \href{https://atariage.com/}{https://atariage.com}
...
\item An Atari  console: the Atari Video Computer  System CX-2600, Sears
  Tele-Games Video  Arcade, Atari 2600\textit{jr} game  system, or Atari
  7800 ProSystem
...
\ifdefined\DEMO\ifdefined\NOSAVE\else
\clearpage
\fi\fi
...
A SEGA \ifdefined\TVNTSC{Genesis or }\fi{}MegaDrive gamepad (or other
...
\else
\textit{Grizzards} is published by AtariAge. \href{https://atariage.com/}{https://atariage.com/}
\fi

It is ``alpha'' quality software.

A demo  version was  created in July  and August,  2021. \ifdefined\DEMO
This manual describes that demo. \fi
...
\includepdf[height=\paperheight,width=\paperwidth]{../Manual/SyrexMap.pdf}
