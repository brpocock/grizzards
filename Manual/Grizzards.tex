...
\begin{tikzpicture}[overlay, remember picture]
  ...
  {\includegraphics[interpolate,width=6in,height=9in]{../Manual/Cover.png}}; 
\end{tikzpicture}
...
\ifdefined\ATARIAGESAVE\else\pagebreak\fi
...
\lettrine[image=true,                lines=5,               findent=3pt,
nindent=3pt]{../Manual/Signpost\TV.png}{Signposts}  provide  information
...
\lettrine[image=true,                lines=5,               findent=3pt,
nindent=3pt]{../Manual/Person\TV.png}{People} will converse with you and
...
\begin{tikzpicture}[overlay, remember picture]
  \node[anchor=north west, xshift=-4pt, yshift=4pt] 
  at (current page.north west)
  {\includegraphics[interpolate,width=6in,height=9in]{../Manual/SyrexMap.png}};
\end{tikzpicture}
