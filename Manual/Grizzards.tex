...
\item \texttt{QUICK FOOT}  --- causes some damage and  may also increase
  its own defend ability.
\item \texttt{GREAT MOJO}  --- causes some damage and  may also increase
  its own attack ability.
\item \texttt{FIRST  AID} ---  heals a small  amount of  health, raising
  your own hit points.
\item \texttt{SIMPLE CURE} --- heals a bit larger amount of health.
\item \texttt{COMMON CURE} --- heals even more health.
