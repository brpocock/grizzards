...
the  joystick  to  select  \texttt{CHANGE} and  revisit  your  name  and
companion choice, or pull back  to select \texttt{BEGIN} your adventure.
...
A monster (or a group of monsters) usually looks like this:
...
\ifdefined\NOSAVE\else You can then press  the joystick forward and back
to choose a different Grizzard to travel with you. \fi
...
\textbf{Left} on  the joystick to  ask them to repeat  themself instead.
...
perform. Press the  joystick forward and back to select  a move. If your
Grizzard knows how  to perform a move,  it will appear in  blue. If your
Grizzard  does not  yet  know how  to  perform a  move,  it will  appear
in black.
...
Combat screen, or at a -Grizzard Depot to review your Grizzard's
...
Their Attack  rating, Defend  rating, or  Maximum Hit  Points may  go up
...
\subsection{Status Effects}\label{sec:StatusEffects}
...
forward.
\ifdefined\DEMO
Your game record will be erased \emph{immediately}.
...
joystick  forward  to  select  ``\texttt{ERASE},''  or  back  to  select
...
their own experience; they only gain  experience when they travel and do
battle as your companion.

If you want to encourage your  Grizzards to metamorphose, stick with the
same Grizzard companion for a while.
...
Be careful  --- when  you encounter  monsters in  their giant  form, you
can't just run away! It becomes a fight to the death.
...
\item Bruce-Robert Pocock --- Programming, Manual text, In-Game Artwork,
  Sound effects
\item Zephyr Salz --- In-Game and Printed Artwork; Music
\end{itemize}
