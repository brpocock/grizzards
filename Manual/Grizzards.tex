...
Some math functions by AtariAge forum user \textt{Omega\-matrix}. Some math
functions  taken from  December  1984 Apple  Assembly  Line. ``Have  You
Played Atari Today'' jingle by  Atari Inc. transcribed by AtariAge Forum
user \texttt{tigger\-the\-hun}. AtariVox and  SaveKey illustrations from the
AtariAge store.
