...
\fi\ifdefined\DEMO Demo \fi\ifdefined\ATARIAGESAVE Official \else Public Release \fi Player's Guide
...
right to choose a memory slot\ifdefined\ATARIAGESAVE\else\footnote{Technical Note: The Slot
...
to  move  to the  next  or  previous  letter.  When you've  entered  six
characters  for  your  name,  the  cursor  will  turn  pink.  Press  the
\textbf{Fire} button to begin your adventure.

\fi

You'll begin in the ruins of  Treble Village after the monsters invaded.
You know that to the east are the extremely dangerous Fire Bog,
...
If  you fail  in your  mission,  your game  is over.  However, you can continue.
