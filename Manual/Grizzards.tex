...
In this demo,  you can only play  with one Grizzard ---  Aquax. The demo
using a memory  device allows you to catch other  Grizzards. In the full
game, you can choose one of three starting Grizzard companions.
...
With a  memory device or the  retail version of the  game cartridge, you
may encounter other Grizzards that you can convince to join your party.
