...
multiple  monsters,  you  must   choose  which  one  to  counter-attack.
Select the target by pressing the joystick left and right.
...
\item Bruce-Robert  Pocock \hdots Programming, Manual,  In-Game Artwork,
  and Music \& Sound effects.
\item Zephyr Salz \hdots Label/Cover Artwork
  \bigskip
...
\item Some math  functions by AtariAge forum  user Omegamatrix; others
  taken from December 1984 Apple Assembly Line.
