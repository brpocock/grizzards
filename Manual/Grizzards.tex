...
through  them.  If  someone  has  already begun  to  play  Grizzards  in
a certain  slot, your screen will  show ``RESUME.'' If a  slot is empty,
you'll see ``BEGIN'' instead.
...
\item[PLAYED 0002 HOURS] --- indicating  the number of hours that you've
  ...
  since you  first began this  adventure. If  you have played  more than
  about 1,000  hours, this display  will no  longer work and  you'll see
  instead ``PLAYED MANY HOURS'' from that point on.
