...
\settrimmedsize{\stockheight}{\dimexpr 5in-15mm}{*}
\setlength\normalsize
\else
...
\newcommand\encircle[1]{%
  \tikz[baseline=(0,0)]
  \draw (0,0) circle [radius=5.5pt] node {\small\textbf{#1}};}
...
\ifdefined\ATARIAGESAVE\englishskip\else\vspace{30pt}\fi
...
\lettrine[image=true,                lines=5,               findent=3pt,
nindent=3pt]{../Manual/QuestionMark.png}{}A~Grue~is~a sinister, lurking
presence  in  the  dark  places  of the  earth.  Its  favorite  diet  is
adventurers,  but its  insatiable appetite  is tempered  by its  fear of
...
upon code  by Garth Wilson.  ``Six Digit  Score'' 48 pixel  wide display
...
Some  math functions  were taken  from the  December 1984  \textit{Apple
  Assembly Line}.  Atari 7800  console detection  logic written  by Fred
Quimby courtesy of Darrell Spice, Jr.
